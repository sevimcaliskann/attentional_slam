...
montage "$1_scale_2_phase_$2.png" "$1_scale_3_phase_$2.png" "$1_scale_4_phase_$2.png" "$1_scale_5_phase_$2.png" "$1_scale_6_phase_$2.png" "$1_scale_7_phase_$2.png" -geometry 101x101 -tile 1x6 "concats/$1_phase_$2.png"
